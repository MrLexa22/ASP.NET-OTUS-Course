...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest aspnetwithreactonehost.client -- --template=react-ts`.
- Создание файла проекта (`aspnetwithreactonehost.client.esproj`).
